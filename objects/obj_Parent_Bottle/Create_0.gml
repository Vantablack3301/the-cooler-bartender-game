...
drawOutline = function() {
	if obj_Manager.isPouring == false {
		var _w = 1;
		...
		if global.gameDifficulty == "new" {
			draw_text(x, y - 10, string_upper(string_char_at(object_index.bottleName, 1)) + string_copy(object_index.bottleName, 2, string_length(object_index.bottleName) - 1))
		}
	}
