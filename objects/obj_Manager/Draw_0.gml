...
if (isPouring && selected != "")
{
	...
	part_type_colour3(part_type, selectedBottle.color1, selectedBottle.color1, selectedBottle.color1)
	//part_particles_burst(part_sys, mouse_x, mouse_y, PouringEffect)
	//part_particles_create(part_sys, mouse_x, mouse_y, part_type, 1)
	part_emitter_region(part_sys, part_emitter, mouse_x - 51, mouse_x - 20, mouse_y + 34,  mouse_y + 54, ps_shape_rectangle, ps_distr_linear);
